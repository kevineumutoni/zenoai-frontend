 ...
 return (
   ...
   >
     <div className="bg-[#091227] border border-[#9FF8F8] rounded-lg shadow-2xl p-8 w-full max-w-xl max-h-[80vh] overflow-y-auto relative">
       <div className="sticky top-0 z-10 flex justify-end bg-[#091227]">
         <button
           onClick={onClose}
       ...
       <div className="space-y-4 text-white text-base">
         ...
         <div>
           <h3 className="text-2xl mb-3 text-[#9FF8F8]">6. Transparency and Explainability</h3>
           <p>
         ...
         <div>
           <h3 className="text-2xl mb-3 text-[#9FF8F8]">7. Contact Us</h3>
           <p>
       ...
       <div className="flex flex-col mt-6">
         <div className="flex items-center justify-between gap-4 w-full">
           <label className="flex items-center gap-2 select-none group w-full">
             ...
             />
             <span className="text-white text-base group-hover:underline">
               Agree to terms and conditions
             </span>
           </label>
           <button
             className="bg-[#9FF8F8] text-[#0B182F] px-6 py-1 rounded-[10px] text-lg shadow transition-all hover:bg-cyan-100"
             onClick={handleAgree}
           >
             Agree
           </button>
