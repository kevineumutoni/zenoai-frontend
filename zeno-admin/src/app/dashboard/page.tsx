...
export default function DashboardPage() {
    return (
      <div className="min-h-screen lg:px-10 2x:pl-35 2x:pr-30 py-6">
        <h1 className="text-3xl md:text-4xl sm:text-[50px xl:text-[50px] 2xl:font-semibold text-[#9FF8F8] mb-2">Dashboard</h1>
