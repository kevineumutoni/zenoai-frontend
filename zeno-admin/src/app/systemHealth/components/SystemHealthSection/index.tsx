...
const SystemHealthSection = ({ runs }: { runs: any[] }) => {
  ...
  return (
    <section className="mb-8 bg-gray-900 p-6 rounded-lg shadow-lg mx-1 lg:mx-15">
      <h2 className="text-xl md:text-2xl lg:text-4xl font-bold mb-4 text-white">System Health</h2>
